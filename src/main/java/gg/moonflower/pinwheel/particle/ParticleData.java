...
public final class ParticleData {
    ...
    public void setTexture(ResourceLocation resourceLocation){
        this.description = new Description(description.identifier, resourceLocation, description.material);
    }
    ...
    public static final ParticleData EMPTY = new ParticleData(new Description("empty", TextureManager.INTENTIONAL_MISSING_TEXTURE, null), Collections.emptyMap(), Collections.emptyMap(), Collections.emptyMap());
